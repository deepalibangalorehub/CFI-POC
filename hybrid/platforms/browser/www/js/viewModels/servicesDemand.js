    ...
    function DemandServiceViewModel() {
     ...
     // $('#totalAmount1').text(dashBoardData.services.beer[0].price)
      ...
      self.nextBtn=function(){
        ...
        {
          "receiver" : "+917205858208",
          "message" : dashBoardData.first_name+" from room no-"+dashBoardData.booking_details.selected_room.room_no+" has been requested for "+selectedDemand
        },
